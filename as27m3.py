...
val1 = client.get_node("ns=2;i=823")
val2 = client.get_node("ns=2;i=824")
val3 = client.get_node("ns=2;i=825")
val4 = client.get_node("ns=2;i=826")
val5 = client.get_node("ns=2;i=827")
val6 = client.get_node("ns=2;i=828")
