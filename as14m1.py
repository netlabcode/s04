...
val1 = client.get_node("ns=2;i=532")
val2 = client.get_node("ns=2;i=533")
val3 = client.get_node("ns=2;i=534")
val4 = client.get_node("ns=2;i=535")
val5 = client.get_node("ns=2;i=536")
val6 = client.get_node("ns=2;i=537")
