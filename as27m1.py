...
val1 = client.get_node("ns=2;i=810")
val2 = client.get_node("ns=2;i=811")
val3 = client.get_node("ns=2;i=812")
val4 = client.get_node("ns=2;i=813")
val5 = client.get_node("ns=2;i=814")
val6 = client.get_node("ns=2;i=815")
