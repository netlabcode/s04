...
val1 = client.get_node("ns=2;i=544")
val2 = client.get_node("ns=2;i=545")
val3 = client.get_node("ns=2;i=546")
val4 = client.get_node("ns=2;i=547")
val5 = client.get_node("ns=2;i=548")
val6 = client.get_node("ns=2;i=549")
